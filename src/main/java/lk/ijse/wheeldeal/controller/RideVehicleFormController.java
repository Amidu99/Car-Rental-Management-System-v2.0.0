...
public class RideVehicleFormController implements Initializable {
    ...
    RideVehicleBO rideVehicleBO = (RideVehicleBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.RIDE_VEHICLE);
    ...
    public void getAllAvailableVehicles(LocalDate rideDate) {
        try {
            ...
            List<VehicleDTO> vehicleList = rideVehicleBO.getAllAvailableVehicles(rideDate);
    ...
    public void handleTableSelection(TableView<VehicleTM> table) {
        table.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                try {
                    InputStream inputStream = rideVehicleBO.getVehicleImage(newSelection.getVehiNo());
                    if (inputStream != null) {
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        if(!txtVehiNo.getText().isEmpty() && rideDate.isAfter(LocalDate.now()) || rideDate.isEqual(LocalDate.now())){
            ...
            try {
                added = rideVehicleBO.addRide(new RideVehicleDTO(rideNo, vehiNo, rideDate.toString()));
            } catch (SQLException | ClassNotFoundException e) {
