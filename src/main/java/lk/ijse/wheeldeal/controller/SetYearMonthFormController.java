        ...
        if(!txtYear.getText().isEmpty() && !txtMonth.getText().isEmpty()) {
            ...
            if (isValidYear) {
                if (isValidMonth) {
                    ...
                    String total = null;
                    try {
                        total = returnBO.getMonthlyIncome(year, month);
            ...
            if(isValidYear) {
                ...
                try {
                    JanuaryIncome = returnBO.getMonthlyIncome(year,"January");   if(JanuaryIncome==null){JanuaryIncome="-";}
                    FebruaryIncome = returnBO.getMonthlyIncome(year,"February");   if(FebruaryIncome==null){FebruaryIncome="-";}
                    MarchIncome = returnBO.getMonthlyIncome(year,"March");   if(MarchIncome==null){MarchIncome="-";}
                    AprilIncome = returnBO.getMonthlyIncome(year,"April");   if(AprilIncome==null){AprilIncome="-";}
                    MayIncome = returnBO.getMonthlyIncome(year,"May");   if(MayIncome==null){MayIncome="-";}
                    JuneIncome = returnBO.getMonthlyIncome(year,"June");   if(JuneIncome==null){JuneIncome="-";}
                    JulyIncome = returnBO.getMonthlyIncome(year,"July");   if(JulyIncome==null){JulyIncome="-";}
                    AugustIncome = returnBO.getMonthlyIncome(year,"August");   if(AugustIncome==null){AugustIncome="-";}
                    SeptemberIncome = returnBO.getMonthlyIncome(year,"September");   if(SeptemberIncome==null){SeptemberIncome="-";}
                    OctoberIncome = returnBO.getMonthlyIncome(year,"October");   if(OctoberIncome==null){OctoberIncome="-";}
                    NovemberIncome = returnBO.getMonthlyIncome(year,"November");   if(NovemberIncome==null){NovemberIncome="-";}
                    DecemberIncome = returnBO.getMonthlyIncome(year,"December");   if(DecemberIncome==null){DecemberIncome="-";}
                    total = returnBO.getAnnualIncome(year);
                }
