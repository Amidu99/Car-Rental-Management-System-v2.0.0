...
public class UserFormController implements Initializable {
    ...
    private void generateNextUserID() {
        try{
            String nextID = userBO.generateNextID();
    ...
    void getAll() {
        try {
            ...
            List<UserDTO> cusList = userBO.getAllUser();

            for(UserDTO userDTO : cusList) {
    ...
    public void txtUserIDOnAction(ActionEvent actionEvent) {
        ...
        if(!userID.isEmpty()){
            ...
            if(userDTO != null){
                ...
                txtPassHint.setText(userDTO.getPassHint());
                txtEmpID.setText(userDTO.getEmpID());
            }else{
                ...
                if (isNameMatched) {
                    if (isPasswordMatched) {
                        if (isEmployeeIDMatched) {
                            ...
                            boolean added = false;
                            try {
                                UserDTO dto = new UserDTO(UserID, UseName, Password, PassHint, EmpID);
                                added = userBO.addUser(dto);
                            } catch (SQLException | ClassNotFoundException e) {
                                new Alert(Alert.AlertType.ERROR, "Something went wrong:\nNot Added.\n"+e).show();
                            }
                            if(added){
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) {
            btnDelete.setOnAction((e) -> {
                ...
                if (result.orElse(no) == yes) {
                    ...
                    try {
                        deleted = userBO.deleteUser(UserID);
